...
keys = [
    ...
    # Take screenshots
    Key([],"Print", lazy.spawn("gscreenshot -c"), desc="Take a screenshot to clipboard"),
    Key(["control" , "shift"],"Print", lazy.spawn("gscreenshot -s -c"), desc="Take a area screenshot"),
    Key(["shift"],"Print", lazy.spawn("gscreenshot"), desc="Launch screenshot window"),
